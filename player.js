...
Player.prototype.tick = function(delta) {
  ...
  if (status) {
	...
	status_msg += "<b>Who?Dinny?</b>: 1=Fireballs (&infin;) 2=Snowballs (&infin;) <br>Dr. Zweistein: 1=Hacking (&infin;) 2=Bombs (";
    } else {
	status_msg += "Who?Dinny?: 1=Fireballs (&infin;) 2=Snowballs (&infin;) <br><b>Dr. Zweistein</b>: 1=Hacking (&infin;) 2=Bombs (";
    }
